  ...
  return (
    <>
      <header className="d-block d-md-flex align-items-center justify-content-between p-2 mb-4">
        ...
        <div>
          <button onClick={() => navigate("/sign-in")} className="btn btn-primary text-white mx-2">Login</button>
          <button onClick={() => navigate("/sign-up")} className="btn btn-primary text-white mx-2">Register</button>
        </div>
        )}
      </header>
    </>
